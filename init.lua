...
-- Git keymaps
vim.keymap.set('n', ']e', ':Gitsigns next_hunk<CR>', { desc = 'Jump to next git edit' })
...
-- Buffer keymaps
vim.keymap.set('n', '<leader>bs', ':vsplit<CR><C-w>l', { desc = '[S]plit buffer' })
vim.keymap.set('n', '<leader>bc', ':clo<CR>', { desc = '[C]lose buffer' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'python', 'elixir' },
